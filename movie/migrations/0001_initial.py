# Generated by Django 3.1 on 2020-09-23 15:03
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('tmdb_id', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='movie.moviedetail')),
            ],
        ),
        migrations.CreateModel(
            name='MovieGallery',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('cast_name', models.CharField(max_length=20)),
                ('cast_role', models.CharField(max_length=50)),
                ('cast_image', models.URLField(blank=True)),
                ('tmdb_id', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='movie.moviedetail')),
            ],
        ),
    ]
